...
class RecepcionCaretaker
{
	...
	public function guardarEstado(RecepcionMemento $memento): void
	{
		$_SESSION['undo_stack'][] = $memento->obtenerEstado();
		$_SESSION['redo_stack'] = array();
	}

	public function deshacer(): ?RecepcionMemento
	{
	...
	public function rehacer(): ?RecepcionMemento
	{
		$redoStack = &$_SESSION['redo_stack'];
